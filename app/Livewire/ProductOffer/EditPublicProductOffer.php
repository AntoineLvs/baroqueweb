...
class EditPublicProductOffer extends Component
{
    use WithFileUploads;
    ...
    public function mount($product_offer)
    {
        ...
        // get offered product
        $offered_product = PublicOfferedProduct::where('public_product_offer_id', $product_offer->id)->get()->first();
    ...
    {
        return view('livewire.product-offer.edit-public-product-offer', [
