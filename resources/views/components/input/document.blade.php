<div class="mt-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
  <label for="documents" class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">
    Documents
...
<div x-data="dataFileDnD()" class="relative flex flex-col p-4 text-gray-400 border border-gray-200 rounded">
    <div x-ref="dnd"
        ...
        <input
            wire:model="file"
            accept="*" type="file"
            class="absolute inset-0 z-auto w-full h-full p-0 m-0 outline-none opacity-0 cursor-pointer"
