<footer class="bg-white">
    <div class="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-12 lg:px-8">
        <nav class="-mb-6 columns-2 sm:flex sm:justify-center sm:space-x-12" aria-label="Footer">
            ...
            <div class="pb-6">
                <a href="{{route('home')}}"
                   class="text-sm leading-6 text-gray-600 hover:text-gray-900">refuelOS</a>
            </div>
        ...
        <p class="mt-10 text-center text-xs leading-5 text-gray-500">&copy; 2024 Elsen Media GmbH | Alle Rechte
            vorbehalten.</p>
        <p class="mt-10 text-center text-xs leading-5 text-gray-900">
            Sämtliche in den Suchergebnissen von refuelOS angezeigte Informationen stammen von externen Quellen und
            stehen unter dem Vorbehalt der Änderung durch die Urheber.refuelOS übernimmt keine Gewähr und/oder Garantie
            für die Richtigkeit der Angaben.</p>
    </div>
</footer>
