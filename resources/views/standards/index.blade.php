...
<main class="flex-1 relative z-0 overflow-y-auto focus:outline-none">
  <div class="py-10">
    <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
      <h1 class="text-2xl font-bold text-gray-900">Standards</h1>
                  ...
                  <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                      ...
                      <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                          <div class="text-sm text-gray-900"> {{$standard->name}}</div>
                        ...
                        <td  class="px-6 py-4 whitespace-nowrap text-left text-sm font-medium">
                          ...
                          <a href="{{ route('standards.edit', $standard) }}" data-toggle="tooltip" data-placement="bottom" title="Edit Project">
