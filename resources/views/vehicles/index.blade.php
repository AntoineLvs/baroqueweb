@extends('layouts.app', ['page' => 'vehicles', 'pageSlug' => 'vehicles', 'section' => 'main'])
@section('content')
                ...
                <div class="py-4">
                    ...
                    <div class="bg-white overflow-hidden shadow rounded-lg divide-y divide-gray-200">
                        <div class="px-4 py-5 sm:p-6">
                            ...
                            <div>
                                <a href="{{ route('vehicles.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent
                                            ...
                                            <table class="min-w-full divide-y divide-gray-200">
                                                ...
                                                @foreach ($vehicles as $vehicle)
                                                    <tr>
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap">
                                                            <div
                                                                class="text-sm text-gray-900"> {{$vehicle->manufacturer->name}}</div>

                                                        </td>

                                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                            {{$vehicle->engine->name}} ({{$vehicle->engine->power_kw}} kw / {{$vehicle->engine->power_ps}} ps)
                                                            <div
                                                                class="text-sm text-gray-500">  {{$vehicle->engine->manufacturer->name}}</div>
                                                        </td>
