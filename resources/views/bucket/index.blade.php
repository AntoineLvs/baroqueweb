@extends('layouts.app', ['page' => 'Bucket', 'pageSlug' => 'bucket', 'section' => 'main'])
@section('content')
...
<main class="flex-1 relative z-0 overflow-y-auto focus:outline-none">
  <div class="py-10">
    <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
      <h1 class="text-2xl font-bold text-gray-900">My Bucket</h1>
    ...
    <div class="max-w-8xl mx-auto px-4 sm:px-6 md:px-8">
      <div class="py-4">
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg divide-y divide-gray-200">
          ...
          <div class="px-4 py-5 sm:px-6">
            <h3 class="card-title">Product Buckets</h3>
                  ...
                  <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                      ...
                      <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @foreach ($bucket_entries as $bucket_entry)
                        <tr>
                            ...
                            <div class="flex items-center">
                              ...
                              <div class="ml-4">
                                <div class="text-sm font-medium text-gray-900">
                                  Entry #{{ $bucket_entry->id }}
                                </div>
                                <div class="text-sm text-gray-500">

                                {{ $bucket_entry->get_offer($bucket_entry->product_offer_id)->tenant->name }}
                                </div>
                              </div>
                            </div>
                          </td>
                          ...
                          <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            @foreach( $bucket_entry->get_offered_products($bucket_entry->product_offer_id) as $product)
                            {{ $product->name }}
                            @endforeach
                          ...
                          <td  class="px-6 py-4 whitespace-nowrap text-left text-sm font-medium">
                            <a href="" data-toggle="tooltip" data-placement="bottom" title="Edit Product">
