  ...
  <form wire:submit.prevent="updateTenant" role="form">
    ...
    <div class="max-w-8xl mx-auto px-4 sm:px-6 md:px-8">
      ...
      <div x-data="{
        ...
        openTab: 1,
        activeClasses: 'bg-indigo-100 text-indigo-700 px-3 py-2 font-medium text-sm rounded-md',
        inactiveClasses: 'text-gray-500 hover:text-gray-700 px-3 py-2 font-medium text-sm rounded-md' }"
        id="tab_wrapper" class="pt-8" >

        <div>
          <ul class="flex">
            <li @click="openTab = 1" :class="{ '-mb-px': openTab === 1 }" class="-mb-px mr-1">
              <a :class="openTab === 1 ? activeClasses : inactiveClasses" class="inline-block text-gray-500 hover:text-gray-700 px-3 py-2 font-medium text-sm rounded-md"  @click.prevent="tab = 'description'; window.location.hash = 'description'" href="#">Profil</a>
            </li>

            <li @click="openTab = 2" :class="{ '-mb-px': openTab === 2 }" class="mr-1">
              <a :class="openTab === 2 ? activeClasses : inactiveClasses" class="inline-block text-gray-500 hover:text-gray-700 px-3 py-2 font-medium text-sm rounded-md"  @click.prevent="tab = 'reviews'; window.location.hash = 'reviews'" href="#">Infos</a>
            </li>
