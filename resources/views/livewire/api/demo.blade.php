            ...
            <div class="p-4 rounded">
                ...
                <div x-data="{ buttonColor: '', backgroundColor: '', fontColor:'' , buttonFontColor: ''}" x-init="buttonColor = document.getElementById('buttonColorPicker').value, backgroundColor = document.getElementById('backgroundColorPicker').value,  fontColor = document.getElementById('fontColorPicker').value, buttonFontColor = document.getElementById('buttonFontColorPicker').value">
                    <div class="flex flex-col xl:flex-row flex bg-gray-200 p-4 rounded">
                        <div class="w-full pl-4" style="min-width: 500px;">
                            <form wire:submit.prevent="submit">
                                @csrf
                                <div class="grid grid-cols-4 gap-6">
                                    <!-- Button Color -->
                                    <div class="col-span-1 border-r border-gray-300 pr-4 flex flex-col items-center justify-center">
                                        <label class="text-sm font-medium text-gray-900" for="buttonColorPicker">Button Color</label>
                                        <div class="flex space-x-4 mt-2">
                                            <input type="color" wire:model.live="buttonColor" id="buttonColorPicker" x-model="buttonColor" class="w-1/2 border border-gray-300">
                                            <input type="text" wire:model.live="buttonColor" x-model="buttonColor" class="w-full max-w-xs border border-gray-300 px-2 py-1">
                                        </div>
                                    </div>

                                    <!-- Background Color -->
                                    <div class="col-span-1 border-r border-gray-300 pr-4 flex flex-col	 items-center justify-center">
                                        <label class="text-sm font-medium text-gray-900 align-middle" for="backgroundColorPicker">Background Color</label>
                                        <div class="flex space-x-4 mt-2">
                                            <input type="color" wire:model.live="backgroundColor" id="backgroundColorPicker" x-model="backgroundColor" class="w-1/2 border border-gray-300">
                                            <input type="text" wire:model.live="backgroundColor" x-model="backgroundColor" class="w-full max-w-xs border border-gray-300 px-2 py-1">
                                        </div>
                                    </div>

                                    <!-- Font Color -->
                                    <div class="col-span-1 border-r border-gray-300 pr-4 flex flex-col	 items-center justify-center">
                                        <label class="text-sm font-medium text-gray-900" for="fontColorPicker">Font Color</label>
                                        <div class="flex space-x-4 mt-2">
                                            <input type="color" wire:model.live="fontColor" id="fontColorPicker" x-model="fontColor" class="w-1/2 border border-gray-300">
                                            <input type="text" wire:model.live="fontColor" x-model="fontColor" class="w-full max-w-xs border border-gray-300 px-2 py-1">
                                        </div>
                                    </div>

                                    <!-- Button Font Color -->
                                    <div class="col-span-1 pr-4 flex flex-col	 items-center justify-center">
                                        <label class="text-sm font-medium text-gray-900" for="buttonFontColorPicker">Button Font Color</label>
                                        <div class="flex space-x-4 mt-2">
                                            <input type="color" wire:model.live="buttonFontColor" id="buttonFontColorPicker" x-model="buttonFontColor" class="w-1/2 border border-gray-300">
                                            <input type="text" wire:model.live="buttonFontColor" x-model="buttonFontColor" class="w-full max-w-xs border border-gray-300 px-2 py-1">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-6 flex space-x-4">
                                    ...
                                    <button type="button" wire:click="resetCiSettings" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                                        ...
                                        <div>
                                            ...
                                            <div class="relative" style="width: 100%; height: auto;">
                                                ...
                                                <div x-data="{ 
                                                    ...
                                                    x-bind:style="{
                                                    'background-color': backgroundColor,   // Style dynamique pour la couleur de fond
                                                    'z-index': 5, 
                                                    'min-width': '400px', 
                                                    'position': 'absolute', 
                                                    'top': '30px', 
                                                    ...
                                                    class="relative shadow rounded-md border border-gray-300">

                                                    <!-- Closure button -->
                                                    <div class="absolute top-1 right-1 cursor-pointer text-sm text-gray-500 hover:text-red-600 mr-2" @click="isHidden = true">
                                                        <span wire:model.live.debounce.500ms="fontColor" x-bind:style="'color: ' + fontColor">ausblenden</span>
                                                    </div>
                                                                ...
                                                                <div class="animated">
                                                                    ...
                                                                    <div class="relative">
                                                                        <div @click="showResultClass = true;" id="searchAreaButton" class="cursor-pointer absolute inset-y-0 start-0 flex items-center ps-3">
                                                                            <span wire:model.live.debounce.500ms="buttonColor" x-bind:style="'color: ' + buttonColor">
                                                                                <svg class="searchAreaButton w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                                                                        ...
                                                                        <button @click="isHvoBlend = true; isHvo100 = true; radius = 100" id="resetButton" type="button" class="text-white absolute end-2.5 bottom-2.5 bg-indigo-600 hover:bg-indigo-700 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" wire:model.live.debounce.500ms="buttonColor" x-bind:style="'background-color: ' + buttonColor">
                                                                            <span wire:model.live.debounce.500ms="buttonFontColor" x-bind:style="'color: ' + buttonFontColor">
                                                                                <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" fill="currentColor" stroke="currentColor">
                                                                ...
                                                                <div class="flex items-center">
                                                                    ...
                                                                    <div>
                                                                        <button type="button"
                                                                            ...
                                                                            class="rounded-full px-2.5 py-1 text-xs font-semibold shadow-sm" wire:model.live.debounce.500ms="buttonColor" x-bind:style="'background-color: ' + buttonColor">
                                                                            <span wire:model.live.debounce.500ms="buttonFontColor" x-bind:style="'color: ' + buttonFontColor">HVO 100</span>
                                                                        </button>
                                                                    </div>
                                                                    ...
                                                                    <div class="ml-2">
                                                                        <button type="button"
                                                                            ...
                                                                            class="rounded-full px-2.5 py-1 text-xs font-semibold shadow-sm" wire:model.live.debounce.500ms="buttonColor" x-bind:style="'background-color: ' + buttonColor">
                                                                            <span wire:model.live.debounce.500ms="buttonFontColor" x-bind:style="'color: ' + buttonFontColor">HVO Blend</span>
                                                                        </button>
                                                                    </div>
                                                                    ...
                                                                    <div class="ml-4 flex items-center justify-between">
                                                                        <div>
                                                                            <label for="radiusRange" class="block text-xs font-medium text-gray-700">
                                                                                <span wire:model.live.debounce.500ms="fontColor" x-bind:style="'color: ' + fontColor">Search Radius (<span x-text="radius"></span> km)</span>
                                                                            </label>
                                        ...
                                        <span class="tooltip text-gray-500" style="z-index: 10; transform: translateX(-90%);">Show on Map</span>
                                                        ...
                                                        <div>
                                                            <div class="w-full flex flex-col items-center justify-center">
                                                                <button @click="showResultClass = !showResultClass" class="w-full mx-auto bg-indigo-600 hover:bg-indigo-700 text-white py-2 px-4 rounded flex items-center justify-between" type="button" wire:model.live.debounce.500ms="buttonColor" x-bind:style="'background-color: ' + buttonColor">
                                                                    <span wire:model.live.debounce.500ms="buttonFontColor" x-bind:style="'color: ' + buttonFontColor">Show Results</span>
