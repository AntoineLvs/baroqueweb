<div>
    ...
    <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl text-center">
            ...
            <br>
            @if($tenant_id == null)
            <span class="mt-6 inline-flex items-center rounded-md bg-red-50 px-2 py-1 text-xs font-medium text-red-700 ring-1 ring-inset ring-red-600/10">You must be connected to access this fonctionnality </span>
            @endif
        </div>
        ...
        <form wire:submit="save" class="mx-auto mt-16 max-w-xl sm:mt-20">
            ...
            <div class="mt-10">
                @if($tenant_id == null)
                <button class="block w-full rounded-md bg-gray-200 px-3.5 py-2.5 text-center text-sm font-semibold shadow-sm hover:bg-gray-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 text-gray-800 cursor-not-allowed" data-tooltip-target="tooltip-login-first" data-tooltip-trigger="hover" data-tooltip-content="Please log in first">Anfrage absenden</button>
                @else
                <button type="submit" class="block w-full rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Anfrage absenden <span wire:loading>...<svg aria-hidden="true" role="status" class="inline w-6 h-6 ml-2 text-gray-200 animate-spin dark:text-gray-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
