    ...
    <div x-show="open" class="relative flex-1 flex flex-col max-w-xs w-full bg-gray-800"
        ...
        <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            ...
            <nav class="mt-5 px-2 space-y-1">
                ...
                <div
                    x-data="{ showAdminLinksMobile: {{ in_array(request()->route()->getName(), ['admin.dashboard', 'product-types.index','base-products.index','map.index','documents.index','base-services.index']) ? 'true' : 'false' }} }">
                    @if($super)
                        <button @click.stop="showAdminLinksMobile = !showAdminLinksMobile"
                                :class="{ 'bg-teal-700': showAdminLinksMobile, 'text-white': showAdminLinksMobile, 'hover:text-white': showAdminLinksMobile }"
                                class="w-full hover:bg-gray-700 flex items-center text-left rounded-md p-2 gap-x-3 text-sm leading-6 font-semibold text-gray-300"
                            ...
                            <svg
                                :class="{ 'rotate-90 text-gray-500': showAdminLinksMobile, 'text-gray-400': !showAdminLinksMobile }"
                                class="ml-auto h-5 w-5 shrink-0" viewBox="0 0 20 20" fill="currentColor"
                                aria-hidden="true">
                    ...
                    <div x-show="showAdminLinksMobile" class=" px-3 py-2"
                         x-transition:enter="transition ease-out duration-700 transform opacity-0"
                         x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100 transform">
        ...
        <div class="flex-shrink-0 flex bg-gray-700 p-4">
            <a href="#" class="flex-shrink-0 group block">
                <div class="flex items-center">
                    <div>
                        <img class="inline-block h-10 w-10 rounded-full" src="{{ asset('assets/img/logo.svg') }}"
                             alt="">
                    </div>
                    <div class="ml-3">
