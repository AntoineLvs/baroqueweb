        ...
        <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5 mt-4 pb-4">
            ...
            <div class="mt-1 sm:mt-0 sm:col-span-2">
                <div class="mt-1 sm:mt-0 sm:col-span-2 w-full md:w-64">
                    ...
                    @error('base_product_id') <span class="text-sm text-red-500 mt-2">{{ $message }}</span> @enderror
                </div>
            </div>
        </div>
        ...
        @if($base_product_id == 2)
            <div class="pt-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5 overflow-hidden" style="max-height: 100px; transition: max-height 0.4s ease-in-out;">
                ...
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    ...
                    <input type="numeric"class="w-40" wire:model="blend_percent" id="blend_percent" min="1" max="99" />

                </div>
                @error('blend_percent') <span class="text-sm text-red-500 mt-2">{{ $message }}</span> @enderror
            </div>
</div> @endif
    ...
    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
        ...
        <div class="mt-1 sm:mt-0 sm:col-span-2">
            <div class="mt-1 sm:mt-0 sm:col-span-2">
                ...
                @error('name') <span class="text-sm text-red-500 mt-2">{{ $message }}</span> @enderror
            </div>
        </div>
    </div>
</div>
    ...
    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
        ...
        <div class="mt-1 sm:mt-0 sm:col-span-2">
            <div class="mt-1 sm:mt-0 sm:col-span-2">
                ...
                @error('data') <span class="text-sm text-red-500 mt-2">{{ $message }}</span> @enderror
            </div>
        </div>
    </div>
</div>
...
<div class="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
        ...
        <div class="mt-1 sm:mt-0 sm:col-span-2">
            ...
            @error('product_unit_id') <span class="text-sm text-red-500 mt-2">{{ $message }}</span> @enderror
        </div>
    </div>
</div>
