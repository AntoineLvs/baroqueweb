<div class="mb-2 max-w-8xl mx-auto px-4 sm:px-6 md:px-8 rounded-md">
    ...
    <!-- Locations Table -->
    <div class="flex flex-col flex-row border border-gray-200 rounded-md mb-6">
        <div style="max-height: 75vh; overflow-y: auto; z-index: 1;" class="{{ $toggleMapValue ? 'hidden' : 'w-full' }}  transition-all duration-2000 shadow rounded-t-md border-b border-gray-200 sm:rounded-l-md sm:border-r-0 sm:rounded-r-md sm:border-b-0 sm:border-b-0 sm:border-t-0">
    ...
    <div class="flex flex-col flex-row border border-gray-200 rounded-md mb-6">
        ...
        <div style="max-height: 75vh;" class="{{ $toggleTableValue ? 'hidden' : 'w-full' }} transition-all duration-2000 bg-white overflow-hidden shadow rounded-b-md border border-gray-200 sm:rounded-r-md sm:border-l-0 sm:border-t-0 sm:border-b sm:rounded-t-md">
