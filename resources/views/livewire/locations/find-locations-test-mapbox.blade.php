<div class="flex flex-col md:flex-row border border-gray-200 rounded-md">
    <div style="z-index: 1; min-width: 350px" class="w-1/5 md:w-1/5 transition-all duration-2000 shadow rounded-t-md border-b border-gray-200 xl:rounded-l-md xl:border-r-0 xl:rounded-r-md xl:border-b-0 xl:border-t-0">
