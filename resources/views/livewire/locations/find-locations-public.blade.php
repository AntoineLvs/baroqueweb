    ...
    <div style="z-index: 5; min-width: 350px;  @if($showResultClasse) height:750px; @endif" class="w-1/5 md:w-1/5 transition-all duration-2000 shadow rounded-t-md border-b border-gray-300 xl:rounded-l-md xl:border-r-0 xl:rounded-r-md xl:border-b-0 xl:border-t-0 bg-white">
        <div class="mx-auto mt-4 mr-4 ml-4">
            <div class="w-full flex flex-col items-center space-y-4">
                <div class="w-full">
                    <div class="animated">
                        <input wire:model.live="filters.search" type="text" id="searchbox" name="searchbox" placeholder="Search..." class="block w-full rounded-md border-0 px-4 py-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center justify-between">
                <div class="mt-2">
                    <div class="flex items-center">
                        <div>
                            <button type="button"
                                wire:click="toggleProduct('HVO100')"
                        ...
                        <div class="ml-2">
                            <button type="button"
                                wire:click="toggleProduct('HVOBlend')"
        ...
        <div>
            <div class="w-full flex flex-col items-center space-y-4 justify-center">
                <button class="w-full mx-auto bg-indigo-600 hover:bg-indigo-700 text-white py-2 px-4 rounded flex items-center justify-between" type="button" wire:click="toggleResults">
