@extends('layouts.app', ['page' => 'Bearbeiten', 'pageSlug' => 'manufacturers', 'section' => 'main'])
@section('content')

    <div class="py-10">
        <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
            <h1 class="text-2xl font-bold text-gray-900">Bearbeiten</h1>
                    ...
                    <div class="px-4 py-5 sm:p-6">
                        <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
                            <div>
                                ...
                                @livewire('manufacturer.edit-manufacturer',
