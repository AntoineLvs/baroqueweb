@extends('layouts.app', ['page' => 'Manufacturers', 'pageSlug' => 'manufacturers', 'section' => 'main'])
@section('content')
            ...
            <div class="py-4">
                ...
                <div class="bg-white overflow-hidden shadow rounded-lg divide-y divide-gray-200">
                    ...
                    <div class="px-4 py-5 sm:p-6">
                        <!-- Content goes here -->
                        Füllen Sie die nachfolgenden Informationen aus, um ein Hersteller anzulegen.
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="px-4 py-5 sm:p-6">
                        <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
                            <div>
                                ...
                                @livewire('manufacturer.create-manufacturer')
