                ...
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                        ...
                        <div class="text-center">
                            ...
                            <div class="mt-2">
                                <a href="#" class="text-sm font-semibold leading-6 text-white">Was ist XTL? <span
                    ...
                    <div class="mx-auto max-w-lg grid grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-1">
                        ...
                        <figure class="relative isolate pt-6 sm:pt-12">
                            ...
                            <blockquote class="text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
                                <p>Gravida quam mi erat tortor neque molestie. Auctor aliquet at porttitor a enim nunc
                                    suscipit tincidunt nunc. Et non lorem tortor posuere. Nunc eu scelerisque interdum eget
