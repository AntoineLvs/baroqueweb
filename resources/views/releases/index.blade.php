                ...
                <div class="py-4">
                    ...
                    <div class="bg-white overflow-hidden shadow rounded-lg divide-y divide-gray-200">
                        ...
                        <div class="px-4 py-5 sm:p-6">
                            ...
                            <div>
                                <a href="{{ route('releases.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent
            text-base font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700
            focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Create Realease</a>
                            </div>
                                            ...
                                            <table class="min-w-full divide-y divide-gray-200">
                                                ...
                                                @foreach ($releases as $release)
                                                    <tr>
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap">
                                                            <div
                                                                class="text-sm text-gray-900">   {{$release->manufacturer->name}}</div>
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap">
                              <span
                              class="px-4 inline-flex text-xs leading-5 font-semibold
                              rounded-full bg-green-200 text-green-800">Available
                             </span>
                                                        </td>
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap text-left text-sm font-medium">
                                                            ...
                                                            <form action="{{ route('releases.destroy', $release) }}"
                                                                  method="post">
                                                                @csrf
                                                                @method('delete')
