@extends('layouts.app', ['page' => 'Show Product Offer', 'pageSlug' => 'show-product-offer', 'section' => 'main'])
@section('content')
...
<main class="flex-1 relative z-0 overflow-y-auto focus:outline-none">
  ...
  <div class="py-10">
    <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <h1 class="text-2xl font-bold text-gray-900">Product Offer  # {{$product_offer->id }}</h1>
