@extends('layouts.app', ['page' => 'Show Product Offer Inquiry', 'pageSlug' => 'show-incoming-product-offer-inquiry', 'section' => 'main'])
@section('content')
...
<main class="flex-1 relative z-0 overflow-y-auto focus:outline-none">
  ...
  <div class="py-10">
    <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <h1 class="text-2xl font-bold text-gray-900">Incoming Product Offer Inquiry # {{$product_offer_inquiry->id }}</h1>
      ...
      <div class="py-4">
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg divide-y divide-gray-200">
          ...
          <div class="bg-white px-4 py-5 border-b border-gray-200 sm:px-6">
            <div class="-ml-4 -mt-2 flex items-center justify-between flex-wrap sm:flex-nowrap">
              ...
              <div class="ml-4 mt-2 flex-shrink-0">
                <a href="{{ route('product-offer-inquiries.index') }}"
          ...
          <div class="px-4 py-5 sm:p-6">
            <!-- Content goes here -->
            Details of the incoming product inquiry.
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="border-t border-gray-200 px-4 py-5 sm:p-0">
              <dl class="sm:divide-y sm:divide-gray-200">
                ...
                <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  ...
                  <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{$product_offer_inquiry->supplier($product_offer_inquiry->supplier_tenant_id)->name }}</dd>
                </div>
                <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
