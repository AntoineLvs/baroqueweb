    ...
    <div class="bg-white">
        ...
        <div class="relative isolate overflow-hidden bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl text-center">
                <h2 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">XTL Freigabe Check</h2>
        ...
        <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl text-center">
                <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Fahrzeug-Suche</h2>
                <p class="mt-2 text-lg leading-8 text-gray-600">Aute magna irure deserunt veniam aliqua magna enim
                    voluptate.</p>
            </div>

                <livewire:search-releases />
